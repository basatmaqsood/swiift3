      ...
      roles: [
        {
          ...
          documents: ['psira', 'license', 'id','CV/Resume'],
        },
        {
          id: 'patrol-guard',
          title: 'Patrol Guard',
      ...
      roles: [
        {
          ...
          documents: ['psira', 'license', 'id', 'firearm', 'tactical','CV/Resume'],
        },
        {
          id: 'armed-officer',
          ...
          documents: ['psira', 'license', 'id', 'firearm','CV/Resume'],
        },
      ],
    },
    command: {
      ...
      roles: [
        {
          ...
          documents: ['psira', 'id', 'qualifications','CV/Resume'],
        },
        {
          id: 'camera-operator',
